...
function getTheme()
{
    ...
    <body>
        ...
        <div class="alert alert-warning">
            ...
            Please learn more <a href="https://www.ic3.gov/">here</a>.
        </div>
                    ...
                    <div class="collapse" id="commonFraud">
                        <div class="card card-body">
                            ...
                            <ul>
                                ...
                                <li><strong>Wire scam</strong> Some fraudsters may ask you to wire them money in order to pay for something or pay a debt. <?php echo getBankName() ?>' online banking dashboard is secured to guard against this</li>
                            </ul>
                        </div>
                    </div>
                </li>
